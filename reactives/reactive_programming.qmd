...
# Avoid Tying Big Changes to Controls

## Direct Interaction

If any slider changes, then update plot
...
ui <- page_sidebar(
  sidebar = sidebar(
    open="always",
    radioButtons("radio", "Select Species", choices=choices),
...
Make a reactive only recalculate given a specific input event. A little easier to type than reformatting wiht `eventReactive()`. In fact, `observeEvent()` is literally defined as \`bindEvent(observeEvent())
